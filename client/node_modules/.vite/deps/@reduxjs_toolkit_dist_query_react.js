import {
  ...
  t
} from "./chunk-SHHSEM5V.js";
import {
  es_exports,
  init_es as init_es2
} from "./chunk-LZNUJ2MH.js";
import "./chunk-NILJDEG4.js";
...
var require_rtk_query_react_cjs_development = __commonJS({
  "node_modules/@reduxjs/toolkit/dist/query/react/rtk-query-react.cjs.development.js"(exports) {
    ...
    var __markAsModule = function(target) {
      return __defProp2(target, "__esModule", { value: true });
    };
      ...
      if (module2 && typeof module2 === "object" || typeof module2 === "function") {
        var _loop_1 = function(key2) {
          if (!__hasOwnProp2.call(target, key2) && key2 !== "default")
            __defProp2(target, key2, { get: function() {
              return module2[key2];
    ...
    var __toModule = function(module2) {
      return __reExport(__markAsModule(__defProp2(module2 != null ? __create(__getProtoOf(module2)) : {}, "default", module2 && module2.__esModule && "default" in module2 ? { get: function() {
    ...
    var import_toolkit22 = __toModule((init_redux_toolkit_esm(), __toCommonJS(redux_toolkit_esm_exports)));
    var import_react3 = __toModule(require_react());
    var import_query = __toModule((init_rtk_query_esm(), __toCommonJS(rtk_query_esm_exports)));
    var import_react_redux2 = __toModule((init_es2(), __toCommonJS(es_exports)));
    ...
    var import_react_redux = __toModule((init_es2(), __toCommonJS(es_exports)));
    ...
    var import_toolkit14 = __toModule((init_redux_toolkit_esm(), __toCommonJS(redux_toolkit_esm_exports)));
    var defaultSerializeQueryArgs2 = function(_c) {
      var endpointName = _c.endpointName, queryArgs = _c.queryArgs;
      return endpointName + "(" + JSON.stringify(queryArgs, function(key, value) {
        return (0, import_toolkit14.isPlainObject)(value) ? Object.keys(value).sort().reduce(function(acc, key2) {
          acc[key2] = value[key2];
          return acc;
        }, {}) : value;
      }) + ")";
    ...
    function buildHooks(_c) {
      ...
      function buildQueryHooks(name) {
        var useQuerySubscription = function(arg, _c2) {
          ...
          var dispatch = useDispatch();
          var stableArg = useStableQueryArgs(skip ? import_query.skipToken : arg, defaultSerializeQueryArgs2, context.endpointDefinitions[name], name);
        ...
        var useQueryState = function(arg, _c2) {
          ...
          var selectDefaultResult = (0, import_react3.useMemo)(function() {
            return (0, import_toolkit22.createSelector)([
              select(stableArg),
          ...
          var querySelector = (0, import_react3.useMemo)(function() {
            return selectFromResult ? (0, import_toolkit22.createSelector)([selectDefaultResult], selectFromResult) : selectDefaultResult;
      ...
      function buildMutationHook(name) {
        return function(_c2) {
          ...
          var mutationSelector = (0, import_react3.useMemo)(function() {
            return (0, import_toolkit22.createSelector)([select({ fixedCacheKey, requestId: promise2 == null ? void 0 : promise2.requestId })], selectFromResult);
    ...
    var import_react_redux3 = __toModule((init_es2(), __toCommonJS(es_exports)));
    ...
    var import_toolkit32 = __toModule((init_redux_toolkit_esm(), __toCommonJS(redux_toolkit_esm_exports)));
    var import_react4 = __toModule(require_react());
    var import_react5 = __toModule(require_react());
    var import_react_redux4 = __toModule((init_es2(), __toCommonJS(es_exports)));
    ...
    function ApiProvider(props) {
      var store = import_react5.default.useState(function() {
        var _c;
        return (0, import_toolkit32.configureStore)({
      ...
      (0, import_react4.useEffect)(function() {
        return props.setupListeners === false ? void 0 : (0, import_query2.setupListeners)(store.dispatch, props.setupListeners);
      }, [props.setupListeners, store.dispatch]);
      return import_react5.default.createElement(import_react_redux4.Provider, {
        store,
        context: props.context
      }, props.children);
    }
    var createApi2 = (0, import_query3.buildCreateApi)((0, import_query3.coreModule)(), reactHooksModule());
  }
});

// node_modules/@reduxjs/toolkit/dist/query/react/index.js
var require_react2 = __commonJS({
  "node_modules/@reduxjs/toolkit/dist/query/react/index.js"(exports, module) {
    if (false) {
      module.exports = null;
    } else {
